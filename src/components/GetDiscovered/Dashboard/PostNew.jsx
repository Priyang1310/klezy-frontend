  ...
  return (
    <>
      ...
      <div className="flex flex-col h-[340px] w-[300px] bg-white rounded-lg p-4 border border-gray-300 gap-0.5 hover:cursor-pointer">
        ...
        {/* <div className="flex gap-3 items-center">
               ...
               <div className="flex flex-col">
                 ...
                 <div className="flex gap-4 text-xs">
                     <p className="flex gap-2 items-center opacity-50"><FaMoneyBills />Stipend</p>
                     <p className="flex gap-2 opacity-50 ml-2">Remote</p>
                 </div>
               </div>
             </div> */}
        {/* Role */}
        <p className="text-md w-full hover:cursor-pointer" onClick={() => setIsModalOpen(true)}>
          {" "}
        ...
        <hr
          className="my-2.5 text-gray-300 hover:cursor-pointer w-full"
          onClick={() => setIsModalOpen(true)}
        />
        ...
        {/* Skills */}
        <div
          className="flex flex-wrap w-full gap-2 hover:cursor-pointer"
          onClick={() => setIsModalOpen(true)}
        >
        ...
        {/* About Role */}
        <div
          className="flex flex-col h-[20%] w-full text-xs font-regular gap-1 text-gray-600 py-1.5 hover:cursor-pointer"
          onClick={() => setIsModalOpen(true)}
        >
