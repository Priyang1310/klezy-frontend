                                ...
                                {postsFiltered.length === 0 ? (
                                    <div className="text-center py-8 lg:py-12">
                                        <div className="mx-auto w-16 h-16 lg:w-24 lg:h-24 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                                            <LuGalleryVerticalEnd className="w-6 h-6 lg:w-10 lg:h-10 text-gray-400" />
                                        </div>
                                        ...
                                        >
                                            <MdOutlineAddToPhotos className="w-4 h-4 lg:w-5 lg:h-5 mr-2" />
                                            Create Post
                                        </button>
                                    </div>
                                ) : (
                            ...
                            {postsFiltered.length === 0 ? (
                                <div className="text-center py-8 px-4">
                                    <div className="mx-auto w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                                        <LuGalleryVerticalEnd className="w-6 h-6 text-gray-400" />
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-[#a100ff] hover:bg-violet-700 rounded-lg transition-colors duration-200"
                                    >
                                        <MdOutlineAddToPhotos className="w-4 h-4 mr-2" />
                                        Create Post
                                    </button>
                                </div>
                            ) : (
