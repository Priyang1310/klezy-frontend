    ...
    >
      ...
      >
        ...
        <div className="mb-8">
          <div className="flex items-center w-full bg-violet-100 px-5 rounded-2xl mb-5">
            <div className="flex flex-col">
              <p className="text-violet-700 text-xl">Tell Your Story</p>
        ...
        <div className="mb-8">
          <div className="flex items-center w-full bg-violet-100 px-5 rounded-2xl mb-5">
            <div className="flex flex-col">
              <p className="text-violet-700 text-xl">Show Your Strengths</p>
              <p className="text-violet-400">
        ...
        <div>
          <div className="flex items-center w-full bg-violet-100 px-5 rounded-2xl mb-5">
            <div className="flex flex-col">
              <p className="text-violet-700 text-xl">Build Your Portfolio</p>
              <p className="text-violet-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="col-span-2">
              ...
              {post.otherLinks?.length > 0 ? (
                ...
                <p className="text-gray-500">No other links added.</p>
              )}
            </div>
            <div className="col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">
