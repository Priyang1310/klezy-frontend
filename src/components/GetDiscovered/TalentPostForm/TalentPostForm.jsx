...
function GetDiscoveredForm({ onClose }) {
	...
	return (
		<div className="bg-white p-6 sm:p-8 rounded-2xl w-full">
            ...
            >
              <svg className="w-6 h-6 bg-gray-50 rounded-4xl" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col sm:flex-row gap-4 lg:gap-6">
                {["Full-time", "Part-time"].map((type) => (
                  <label key={type} className="flex items-center">
                    ...
                    />
                    <span className="text-gray-700 text-sm lg:text-base">{type}</span>
                  </label>
                ))}
              </div>
            ...
            <div className="relative">
              ...
              {errors.internshipDuration && (
                <div className="text-red-500 text-sm mt-1">
                  {errors.internshipDuration.value && <p>{errors.internshipDuration.value}</p>}
                  {errors.internshipDuration.unit && <p>{errors.internshipDuration.unit}</p>}
                </div>
              )}
            </div>
            ...
            {formData.internshipType === "Paid" && (
              <div className="relative">
                ...
                {errors.internshipStipendRange && (
                  <div className="text-red-500 text-sm mt-1">
                    {errors.internshipStipendRange.min && <p>{errors.internshipStipendRange.min}</p>}
                    {errors.internshipStipendRange.max && <p>{errors.internshipStipendRange.max}</p>}
                  </div>
                )}
              </div>
            )}
        ...
        {formData.workBasis.Freelance && (
          <div className="relative">
            ...
            {errors.freelancePaymentRange && (
              <div className="text-red-500 text-sm mt-1">
                {errors.freelancePaymentRange.min && <p>{errors.freelancePaymentRange.min}</p>}
                {errors.freelancePaymentRange.max && <p>{errors.freelancePaymentRange.max}</p>}
              </div>
            )}
          </div>
        )}
    ...
    <div className="relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
        <div className="flex-1">
          <input
            ...
            onChange={(e) =>
              handleNestedChange("experience", "min", e.target.value)
            }
            type="number"
            min="0"
            placeholder="Min"
            className={`w-full h-11 px-4 py-2.5 lg:py-3 border rounded-lg focus:ring-2 focus:ring-purple-100 transition-all duration-200 hover:border-purple-400 text-sm lg:text-base ${
              errors.experience?.min ? "border-red-500" : "border-gray-300"
            }`}
          />
        </div>
        <div className="flex-1">
          <input
            ...
            onChange={(e) =>
              handleNestedChange("experience", "max", e.target.value)
            }
            type="number"
            min="0"
            placeholder="Max"
            className={`w-full h-11 px-4 py-2.5 lg:py-3 border rounded-lg focus:ring-2 focus:ring-purple-100 transition-all duration-200 hover:border-purple-400 text-sm lg:text-base ${
              errors.experience?.max ? "border-red-500" : "border-gray-300"
            }`}
          />
        </div>
        <div className="flex-1">
          <select
            ...
            onChange={(e) =>
              handleNestedChange("experience", "unit", e.target.value)
            }
            className={`w-full h-11 px-4 py-2.5 lg:py-3 border rounded-lg focus:ring-2 focus:ring-purple-100 transition-all duration-200 hover:border-purple-400 text-sm lg:text-base ${
              errors.experience?.unit ? "border-red-500" : "border-gray-300"
            }`}
          >
            <option value="">Select Unit</option>
            <option value="Years">Years</option>
      ...
      {errors.experience && (
        <div className="text-red-500 text-sm mt-1 space-y-1">
          {errors.experience.min && <p>{errors.experience.min}</p>}
          {errors.experience.max && <p>{errors.experience.max}</p>}
          {errors.experience.unit && <p>{errors.experience.unit}</p>}
        </div>
      )}
    </div>
				...
				>
					...
					<div className="relative col-span-1 lg:col-span-2">
						...
						<input
							...
							className={`w-full h-12 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-purple-100 transition-all duration-200 hover:border-purple-400 ${
								errors.resumeFile
									? "border-red-500"
									: "border-gray-300"
							}`}
								...
								<div className="mt-2 space-y-2 sm:space-y-3">
									...
									<div className="relative">
										<textarea
											...
											className={`w-full h-11 pr-10 sm:pr-12 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-purple-100 transition-all duration-200 hover:border-purple-400 resize-y min-h-[80px] sm:min-h-[100px] ${
												errors[
							...
							<div key={index} className="mb-4 sm:mb-6">
								<div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
									<input
										...
										className={`w-full h-11 sm:w-1/2 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-blue-400 ${
