...
function GetDiscoveredForm({ onClose }) {
  ...
  if (formData.workExperience.length > 0) {
    formData.workExperience.forEach((exp, index) => {
      ...
      if (!exp.role.trim()) {
        newErrors[`workExperience${index}Role`] = "Role is required";
      }
      if (!exp.company.trim()) {
        newErrors[`workExperience${index}Company`] = "Company is required";
      }
      if (!exp.description.trim()) {
        newErrors[`workExperience${index}Description`] = "Description is required";
      }
    });
  }
  ...
  if (formData.otherLinks.length > 0) {
    formData.otherLinks.forEach((linkObj, index) => {
      ...
      if (
        !linkObj.url ||
        !/^https:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)$/.test(linkObj.url)
      ) {
        newErrors[`link${index}`] = "A valid URL is required (must start with https://)";
      }
    });
  }
    ...
    >
      ...
      <div className="mt-2 space-y-2">
        <input
          ...
          className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 ${
            errors[`projectTitle${index}`] ? "border-red-500" : "border-gray-300"
          }`}
        />
  ...
  {formData.workExperience.map((experience, index) => (
    ...
    >
      ...
      <div className="mt-2 space-y-2">
        <p className=" pl-4 text-sm text-gray-500">Start Date</p>
        <input
          type="date"
          ...
          className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 ${
            errors[`workExperience${index}StartDate`] ? "border-red-500" : "border-gray-300"
          }`}
        />
        ...
        <p className=" pl-4 text-sm text-gray-500">End Date</p>
        <input
          type="date"
          ...
          className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 ${
            errors[`workExperience${index}EndDate`] ? "border-red-500" : "border-gray-300"
          }`}
        />
        ...
        <input
          ...
          placeholder="Role"
          className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 ${
            errors[`workExperience${index}Role`] ? "border-red-500" : "border-gray-300"
          }`}
        />
        ...
        <input
          ...
          className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 ${
            errors[`workExperience${index}Company`] ? "border-red-500" : "border-gray-300"
          }`}
        />
        ...
        <div className="relative">
          <textarea
            ...
            className={`w-full pr-10 px-4 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 resize-y min-h-[100px] ${
              errors[`workExperience${index}Description`] ? "border-red-500" : "border-gray-300"
            }`}
          />
          <button
            type="button"
            onClick={() =>
              enhanceField("workExperience", experience.description, index, "description")
            }
