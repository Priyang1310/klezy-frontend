      ...
      <div className="md:hidden rounded-t-2xl mb-6 border-b border-gray-200 w-full mx-auto py-4">
        ...
        <div className="flex justify-between items-center px-4 text-sm">
          <div className="flex flex-col items-center">
            ...
            <span className="text-violet-600 text-center leading-tight">About You</span>
          </div>
          <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center">
                    ...
                    <div className="relative col-span-full lg:col-span-2">
                        ...
                        <div className="relative">
                            <textarea
                                ...
                                rows={4}
                                className={`w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 text-sm sm:text-base resize-none ${
                                    errors.aboutSelf
                                        ? "border-red-500"
                                        : "border-gray-300"
                                }`}
            ...
            {step === 2 && (
                <form className="grid grid-cols-1 gap-6">
                    ...
                    <div className="relative col-span-full">
                        ...
                        {errors.experience && (
                            <div className="text-red-500 text-xs sm:text-sm mt-1 space-y-1">
                                {errors.experience.min && (
                    ...
                    <div className="col-span-full flex flex-col sm:flex-row justify-between gap-3 sm:gap-4 mt-6 pt-4 border-t border-gray-200">
                        <button
                            type="button"
                            onClick={handleBack}
            ...
            {step === 3 && (
                ...
                >
                    <h3 className="col-span-1 lg:col-span-2 text-lg sm:text-xl font-semibold text-[#7900BF] mb-3 sm:mb-4">
                    ...
                    <div className="relative col-span-1 lg:col-span-2">
                        ...
                        <input
                            ...
                            className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 ${
                    ...
                    <div className="relative col-span-1 lg:col-span-2">
                        ...
                        {formData.projects.map((project, index) => (
                            <div
                                key={index}
                                className="mb-4 p-3 sm:p-4 border rounded-lg bg-gray-50"
                            >
                                ...
                                <div className="mt-2 space-y-2 sm:space-y-3">
                                    ...
                                    <div className="relative">
                                        <textarea
                                            ...
                                            className={`w-full pr-10 sm:pr-12 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 resize-y min-h-[80px] sm:min-h-[100px] ${
                                                errors[
                        ...
                        <button
                            ...
                            className="flex items-center text-purple-600 hover:text-purple-800 text-sm sm:text-base"
                        >
                            <FaPlus className="mr-2 w-3 h-3 sm:w-4 sm:h-4" /> Add Project
                        </button>
                    </div>
                    ...
                    <div className="relative col-span-1 lg:col-span-2">
                        ...
                        {formData.workExperience.map((experience, index) => (
                            ...
                            >
                                ...
                                <div className="mt-2 space-y-2 sm:space-y-3">
                                    {/* Date inputs - side by side on larger screens */}
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
                                        <div>
                                            <p className="pl-2 text-xs sm:text-sm text-gray-500 mb-1">
                                                Start Date
                                            </p>
                                            <input
                                                type="date"
                                    ...
                                    {/* Role and Company - side by side on larger screens */}
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
                                        <div>
                                            <input
                                                type="text"
                        ...
                        <button
                            ...
                            className="flex items-center text-purple-600 hover:text-purple-800 text-sm sm:text-base"
                        >
                            <FaPlus className="mr-2 w-3 h-3 sm:w-4 sm:h-4" /> Add Work Experience
                        </button>
                    </div>
                    ...
                    <div className="relative col-span-1 lg:col-span-2">
                            ...
                            >
                                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                                    <input
                                        ...
                                        className={`w-full sm:w-1/2 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-blue-400 ${
                                    ...
                                    <button
                                        ...
                                        className="text-red-500 hover:text-red-700 p-2 sm:p-1 self-center"
                                    >
                        ...
                        <button
                            ...
                            className="flex items-center text-purple-600 hover:text-purple-800 text-sm sm:text-base"
                        >
                            <FaPlus className="mr-2 w-3 h-3 sm:w-4 sm:h-4" /> Add Link
                        </button>
                    </div>
                    ...
                    <div className="relative col-span-1 lg:col-span-2">
                        ...
                        <div className="relative">
                            <textarea
                                ...
                                className="w-full pr-10 sm:pr-12 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-purple-400 border-gray-300 resize-y min-h-[80px] sm:min-h-[100px]"
                            />
                            <button
                                type="button"
                                onClick={() =>
                    ...
                    <div className="col-span-1 lg:col-span-2 flex flex-col sm:flex-row justify-between gap-3 sm:gap-4 mt-4 sm:mt-6">
                        ...
                        <button
                            type="submit"
                            className="w-full sm:w-auto bg-purple-600 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-105 text-sm sm:text-base order-1 sm:order-2"
                        >
                            Submit
                        </button>
                    </div>
