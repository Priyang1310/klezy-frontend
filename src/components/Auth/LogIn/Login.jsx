...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://62.72.13.232:3333/api/auth/signin`, {
        method: "POST",
        headers: {
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* <div className="absolute inset-0 overflow-hidden h-full w-full z-0">
            ...
            <div className="absolute left-[25%] -bottom-[75%] rounded-full w-[914px] h-[914px] border-[100px] opacity-15 border-violet-500 -translate-x-1/2 -translate-y-1/2 z-0"></div>
          </div> */}
