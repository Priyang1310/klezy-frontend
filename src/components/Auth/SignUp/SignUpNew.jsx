...
//     .has().digits()
//     .has().symbols()
//     .has().not().spaces(); // Optional: disallow spaces
...
//         tenYearsAgo.setFullYear(today.getFullYear() - 14);
...
//         if (EmailOTP) {
//             if (!validateEmailOTP()) {
//                 newErrors.EmailOTP = EmailOTP !== "1234" ? "Invalid Email OTP" : "";
//             }
//         }
...
//     const handleOnClickNextForThirdSection = () => {
//         const newErrors = {
//             phoneNumber: !phoneNumber ? "Phone number is required" : "",
//             // email: !email ? "Email is required" : "",
//             PhoneOTP: !PhoneOTP ? "Phone verification code is required" : "",
...
//         if (PhoneOTP) {
//             if (!validatePhoneOTP()) {
//                 newErrors.PhoneOTP = PhoneOTP !== "1234" ? "Invalid Phone OTP" : "";
//                 // newErrors.EmailOTP = EmailOTP !== "1234" ? "Invalid Email OTP" : "";
//             }
//         }
...
//     const passwordValidation = (password) => {
//         // console.log("passwordValidation function pan gayu and password is: ", password);
//         const validationErrors = schema.validate(password, { details: true });

//         if (validationErrors.length > 0) {
//             const errorMessage = "Password must be at least 8 characters and include: A-Z, a-z, 0-9, and symbols like @, #, $, % with no space";
...
//     const handleGetStarted = () => {
//         // console.log("handleGetStarted ma password: ", password);
//         // e.preventDefault();
//         const newErrors = {
//             password: "",
//             confirmPassword: "",
//         };
//         if (!passwordValidation(password)) {
//             setErrors((prev) => ({ ...prev, password: "Password must be at least 8 characters and include: A-Z, a-z, 0-9, and symbols like @, #, $, % with no space" }));
//             console.log(errors);
//             return;
//         }
//         else if (!passwordValidation(confirmPassword)) {
//             setErrors((prev) => ({...prev, password: ""}));
//             setErrors((prev) => ({ ...prev, confirmPassword: "confirm password is not matching with password" }));
//             console.log(errors);
//             return;
//         }
//         else if (password !== confirmPassword) {
...
//         // setErrors((prev) => ({ ...prev, ...newErrors }));
//         console.log("errors: ", errors);
//         const hasErrors = Object.values(newErrors).some((error) => error) || errors.password;
...
//                             <div className="absolute left-[25%] -bottom-[75%] rounded-full w-[814px] h-[814px] border-[100px] opacity-5 border-violet-500 -translate-x-1/2 -translate-y-1/2 z-0"></div>
//                         </div>
//                         <div className="flex items-center justify-center gap-10 w-[400px] h-fit z-10 bg-white px-8 rounded-4xl shadow-lg shadow-[#5C058E] text-center text-sm">
        ...
        <>
            <AnimatePresence mode="wait">
                ...
                {step === 2 && (
                    ...
                    >
                        <div className="absolute inset-0 overflow-hidden h-full w-full z-0">
                            <div className="absolute -right-[50%] top-[100%] w-[887px] h-[887px] opacity-20 bg-violet-500 rounded-full border border-white blur-[3%] -translate-x-1/2 -translate-y-1/2"></div>
                ...
                {step === 4 && (
                    ...
                    >
                        ...
                        <div className="flex gap-10 w-[800px] h-[500px] z-10 bg-white p-8 rounded-4xl shadow-lg shadow-[#5c058e] text-center text-sm items-center justify-center">
                            <div className="flex flex-col h-full w-1/2 gap-1 rounded-lg justify-center">
                                <div className="flex flex-col mb-2 items-center gap-0.5">
                                    <h2 className="text-4xl font-bold text-[#5E0194]">
                                        Create Password
                                    </h2>
                                    <p className="text-[#786D7F] opacity-[86%] text-sm">
                                        Set a strong password to secure your
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <button
                                        className={`${agreed ? "bg-[#5E0194] hover:bg-violet-800" : "bg-gray-300"} ${agreed ? "text-white" : "text-gray-700"} w-[50%] p-3 rounded-lg shadow-md mx-auto transition-all duration-300`}
                                        onClick={handleGetStarted}
                                        disabled={!agreed}
                                    >
                                        Get Started
